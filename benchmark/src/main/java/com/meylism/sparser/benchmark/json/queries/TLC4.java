...
public class TLC4 extends DefaultJsonQueryDescription {
  ...
  @Override public Predicate getQuery() {
    ...
    SimplePredicate vendor1 = new KeyValueMatchPredicate(new PredicateKey("payment_type"), "1");
    SimplePredicate vendor2 = new KeyValueMatchPredicate(new PredicateKey("payment_type"), "2");
    SimplePredicate tip = new KeyValueMatchPredicate(new PredicateKey("RatecodeID"), "2.0");
